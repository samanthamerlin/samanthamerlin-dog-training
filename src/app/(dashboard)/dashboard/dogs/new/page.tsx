  ...
  const onSubmit = async (data: DogFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(result.error || "Failed to add dog");
      }
    } catch {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Add a Dog</h1>
          <p className="text-muted-foreground">
            Add your dog&apos;s profile to book training services
          </p>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Help us keep your dog safe</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                      <div className="space-y-0.5">
                        <FormLabel>Vaccinations Up to Date</FormLabel>
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Vaccination Expiry Date</FormLabel>
                      <FormControl>
                        <Input type="date" {...field} />
                      </FormControl>
                      <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Any allergies, conditions, or health concerns..."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Special diet requirements, food allergies..."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Help us understand your dog better</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <FormField
                control={form.control}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Describe your dog's personality (friendly, shy, energetic, calm...)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="BASIC">Basic (sit, stay, come)</SelectItem>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                      <div className="space-y-0.5">
                        ...
                        <FormDescription>
                          Is your dog comfortable around children?
                        </FormDescription>
                      </div>
                      <FormControl>
                        <Switch
          ...
          <div className="flex gap-4">
            <Button type="button" variant="outline" asChild>
              <Link href="/dashboard/dogs">Cancel</Link>
            </Button>
